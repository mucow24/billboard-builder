...
| CS-07 | Canvas | Select tool, item already selected | Click selected item | Drag-ready manipulation starts instead of reselect noise | Item remains selected and enters transform session | user-flow | Chromium | Partial: transform suites cover this indirectly |
...
| GD-02 | Canvas | Group selected | Click child inside group | Child affordance visible, group-only controls hidden | Child selected | user-flow | Chromium + cross-browser subset | Covered in [e2e/editor.groups.spec.ts](/home/mikek/src/billboard-builder/e2e/editor.groups.spec.ts) |
| GD-03 | Canvas | Group selected, one child already selected | Click sibling child | Sibling child affordance visible | Sibling child selected | user-flow | Chromium | Covered in [e2e/editor.groups.spec.ts](/home/mikek/src/billboard-builder/e2e/editor.groups.spec.ts) |
| GD-04 | Canvas | Outer group selected | Click inner group content | Inner group affordance visible | Inner group selected | user-flow | Chromium + cross-browser subset | Covered in [e2e/editor.groups.spec.ts](/home/mikek/src/billboard-builder/e2e/editor.groups.spec.ts) |
| GD-05 | Canvas | Inner group selected | Click leaf in inner group | Leaf affordance visible | Leaf selected | user-flow | Chromium + cross-browser subset | Covered in [e2e/editor.groups.spec.ts](/home/mikek/src/billboard-builder/e2e/editor.groups.spec.ts) |
...
| GD-14 | Canvas | Grouped child is visible only in the off-canvas overflow preview | Click grouped content once, then click the same child again | Group affordance yields to child affordance | Off-canvas child drill-in follows the direct item-hit path | user-flow | Chromium | Covered in [e2e/editor.groups.spec.ts](/home/mikek/src/billboard-builder/e2e/editor.groups.spec.ts) |
...
| ST-15 | Canvas | Rectangle selected, resize handle visible in the off-canvas overflow preview | Drag the off-canvas resize handle | Resize affordance stays live | Off-canvas handle resize commits like the on-canvas case | user-flow | Chromium | Covered in [e2e/editor.transforms.spec.ts](/home/mikek/src/billboard-builder/e2e/editor.transforms.spec.ts) |
...
| PI-04 | Properties | Multi-selection active | Inspect panel | Multi-selection heading and shared opacity controls visible | No mutation | user-flow | Chromium | Covered in [e2e/editor.groups.layers.spec.ts](/home/mikek/src/billboard-builder/e2e/editor.groups.layers.spec.ts) |
...
| FL-06 | Toolbar/File | Text selected | Upload font and select it | Font picker updates | Text font changes | user-flow | Chromium | Covered in [e2e/editor.files-and-persistence.spec.ts](/home/mikek/src/billboard-builder/e2e/editor.files-and-persistence.spec.ts) |
