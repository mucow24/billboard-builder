...
export const shapesGeneratorSpec: GeneratorSpec<ShapesGeneratorParams> = {
  ...
  fields: [
    ...
    { key: 'shapeCount', label: 'Count', type: 'range', min: 0, max: 64, step: 1 },
    { key: 'shapeMinSize', label: 'Min Size', type: 'range', min: 4, max: 240, step: 1 },
    { key: 'shapeMaxSize', label: 'Max Size', type: 'range', min: 8, max: 320, step: 1 },
    { key: 'shapeRotation', label: 'Rotation', type: 'range', min: 0, max: 1, step: 0.01 },
    { key: 'shapeOpacity', label: 'Opacity', type: 'range', min: 0, max: 1, step: 0.01 },
    { key: 'shapeOutline', label: 'Outline Width', type: 'range', min: 0, max: 24, step: 1 },
    { key: 'shapeMix', label: 'Fill Mix', type: 'range', min: 0, max: 1, step: 0.01 },
