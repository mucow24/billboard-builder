...
export const bandsGeneratorSpec: GeneratorSpec<BandsGeneratorParams> = {
  ...
  fields: [
    ...
    { key: 'stripeCount', label: 'Band Count', type: 'range', min: 2, max: 64, step: 1 },
    { key: 'stripeAngle', label: 'Band Angle', type: 'range', min: -90, max: 90, step: 1 },
    { key: 'stripeThickness', label: 'Band Thickness', type: 'range', min: 8, max: 220, step: 1 },
    { key: 'stripeSpacingJitter', label: 'Spacing Jitter', type: 'range', min: 0, max: 1, step: 0.01 },
    { key: 'stripeOffset', label: 'Band Offset', type: 'range', min: -1, max: 1, step: 0.001 },
    { key: 'stripeSkew', label: 'Skew Intensity', type: 'range', min: 0, max: 1, step: 0.01 },
    { key: 'stripeContrast', label: 'Color Contrast', type: 'range', min: 0, max: 1, step: 0.01 },
    { key: 'stripeGlow', label: 'Glow', type: 'range', min: 0, max: 0.6, step: 0.01 },
